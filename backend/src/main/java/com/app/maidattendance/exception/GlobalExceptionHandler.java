...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleDuplicateCheckIn(DuplicateCheckInException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiResponse.error(ex.getMessage()));
    }

    @ExceptionHandler(GeofenceValidationException.class)
    public ResponseEntity<ApiResponse<Void>> handleGeofenceValidation(GeofenceValidationException ex) {
