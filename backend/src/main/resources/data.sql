...
INSERT INTO users (id, full_name, phone_number, role, is_active)
VALUES 
(1, 'Priya Sharma (Employer)', '+919876543210', 'EMPLOYER', TRUE),
(2, 'Sunita Devi (Maid)', '+919811122233', 'MAID', TRUE),
(3, 'Anita Kumari (Maid)', '+919844455566', 'MAID', TRUE);

-- 2. Household Location (Employer Priya's apartment)
-- Coordinates: Connaught Place, New Delhi (28.6315° N, 77.2167° E)
INSERT INTO household_locations (id, employer_id, house_name, address, latitude, longitude, geofence_radius_meters, dwell_time_minutes)
VALUES 
(1, 1, 'Sharma Residence - Flat 402', 'B-Block, Green Park Heights, New Delhi', 28.63150000, 77.21670000, 50, 3);
